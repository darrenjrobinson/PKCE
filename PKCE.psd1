@{
    RootModule           = 'PKCE.psm1'
    ModuleVersion        = '1.0.2'
    GUID                 = '9344c878-ef63-475e-8635-316fe8907c8a'
    Author               = 'Darren J Robinson'
    CompanyName          = 'Community'
    Copyright            = '(c) 2023 Darren J Robinson. All rights reserved.'
    Description          = "Generate OAuth 2.0 Proof Key for Code Exchange (PKCE) 'code_challenge' and 'code_verifier' for use with an OAuth2 Authorization Code Grant flow"
    PowerShellVersion    = '5.1'
    CompatiblePSEditions = 'Desktop', 'Core'
    RequiredModules      = ''
    FunctionsToExport    = @('New-PKCE')
    CmdletsToExport      = @()
    VariablesToExport    = @()
    AliasesToExport      = @()
    PrivateData          = @{
        PSData = @{
            ProjectUri = 'https://github.com/darrenjrobinson/PKCE'
        } 
    } 
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDfSPMzT2JDBlfJ
# eXULEHdnwXtr9EeZK42xCnrcnK129KCCIS4wggWNMIIEdaADAgECAhAOmxiO+dAt
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIN1xqK8fw1bi
# sGjmSkZeQWKfezxYtoYedCtY/Yn6yv4FMA0GCSqGSIb3DQEBAQUABIICAJ6cJhLC
# 0frKUyWOeN0Y/JlT0IWJ+0BVfNDE7PLhMpmCcsGVzwrDEWxO9XAg9ZjsdjAKHT5+
# imFlLr/panv8dFttUZ2Heyi4PUIy/ZibQjMn1cY9AJqzMgsGqI/Hbw7qnt9hd5sk
# ul2WxhABrdMub0oihCVMaTj61uEjW83kdw800yavJr+ZYhPKCQtKZbCyMBsb7eLy
# WUMGL03amIOJ83oAJ+ocdMfesW56sSTbafcZ4sIp1w1Q6WJEy7FuTRi3ep6lFw9v
# W9GrC2eUvTMYakcs+3Thu2VSDye5r4xMCkk3Q/UYnQoK6R2UGX/a3oQji7IFDx2K
# hcpBnnJDQ7/wMQLK81JXdvghzwrIDTErfexHn6gFo1fqP/Ff/c8CQ3GrTdt4Y0dg
# LuMgGsDhlwtZyN6MC6JrIQqawipkvSMdtYSlG2Mg4EReUZqXf80JYglfizLtcWLF
# pssfypmnPt57lfBwQAmAFeT7lcCi1lbH0B9jCYdX7ZKm0E2h6Nvefs52yL7pdFgz
# qRyYy1XlOAK7e17osbVsOXZLEvEtMlNOTeEv+BTHg1SWIFMXzJMmJ/uLCWUW1pT0
# m0cDh6nNrhM7pW963b7+yALtGgWVMMFYe3hLbGqBxSXdF2IPqixBJhi2RNYa7YJr
# k8K0aR6JjNUpgVSLeo9wWuoPl7ncFUxKYD2ToYIDIDCCAxwGCSqGSIb3DQEJBjGC
...
# MTAyNzIyMjQyMFowLwYJKoZIhvcNAQkEMSIEIMAiwvKGKMAoON5ZaMj/7BmAUvcV
# VXSbgDrJc1xYKVl4MA0GCSqGSIb3DQEBAQUABIICADcA3Wwzd8ltu4FAUOeutwGU
# o1V3b5H/nGw5HuSxY0WflCoijW52MMOHjn3GK1RgOm4ZIMJ7AgVs1mMmZP92Uv8u
# eNV+yITIYLJAgs7E6MBoIdPQ1/zV+e2XUE1QcSWQ326QOVmJ7I4naRBmaomzaklW
# bNPm4/8Yfqk/64i4Xto7DU62JtKf6Vy+SRE3zgj9bUQQ3/BtUshfA1qjS5fIJGx2
# bMMRRvn4/KwxIwdd2VM/ER6wmxvVKZkeMwGY/jzls06XeWFf0n+RnGFbgCciwLTI
# qoGgy+cQvksrzFOe9LHpV6U9iRj4w7jGwlSPPHKUHwWbZtg2h+Gt8jYYfDbXNpCh
# Yiv0C0elZgibNSIeuDdGNu8ciRGQLeYRE06GTY9daL9Byl3cRN2MA78CX25ND6qP
# UXxD+JTR7pLL3YxnkyGpPjJ+Ugnbm258BOZg3H7xo+9YAvyzIyFQYO6XNGC6haAB
# ngduSnMwrSV+HUlRBA+8oKNQhWpC7gKyOoaXctf0wRMBN12o/zHKyudCf5RScPyj
# TvtCgnHXUGJZ9BYydHZm7sqYzmwHqDmMIWFhuw+mPFq8kHr1oCCSBwuK319NFdwr
# q4GQU9fORU+l+OVpyXSlgejCEYWG+m805haaBf/rqYDTW23ijdHKeENHJzgwLVSO
# z6eCva49EipGpkxFTK4i
